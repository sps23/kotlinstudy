package silverstar.coursera.kotlin4jd.week4.board
...
open class SquareBoardImpl(override val width: Int) : SquareBoard {
    ...
    override fun Cell.getNeighbour(direction: Direction): Cell? =
        when (direction) {
            Direction.UP -> cells[Pair(i - 1, j)]
            Direction.DOWN -> cells[Pair(i + 1, j)]
            Direction.LEFT -> cells[Pair(i, j - 1)]
            Direction.RIGHT -> cells[Pair(i, j + 1)]
        }
}
